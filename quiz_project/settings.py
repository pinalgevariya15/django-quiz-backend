...
SECRET_KEY = 'django-insecure-z*h)n%2-y7%i_s620*s+1s=zux$2(i!w)i-b$j^e$49i#p^p_k'
...
# Swagger Configurations for Interactive Testing
SWAGGER_SETTINGS = {
    ...
    'TAGS_SORTER': None,  # Preserves URL registration order (auth, admin, quiz)
}
